...
import mySvg from "../assets/blue.svg";
...
function Dashboard() {
  ...
  return (
    ...
    >
      <div className="flex flex-col min-h-screen bg-slate-100 " style={{}}>
        <div className="flex items-center justify-between p-6 bg-gradient-to-r from-slate-200 to-slate-300 shadow-md">
          <h1 className="text-2xl font-semibold text-Black font-serif">
            Presto
          </h1>
          <button
